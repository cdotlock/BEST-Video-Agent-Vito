      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            rejectedWorkflowPaths: { type: "array", items: { type: "string" } },
            providers: { type: "array", items: { type: "string", enum: ["unsplash", "pexels", "pixabay"] } },
            editingHints: { type: "array", items: { type: "string" } },
            cameraHints: { type: "array", items: { type: "string" } },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            hasImageReference: { type: "boolean" },
            hasReferenceVideo: { type: "boolean" },
            hasFirstFrameReference: { type: "boolean" },
            hasLastFrameReference: { type: "boolean" },
            wantsMultiClip: { type: "boolean" },
            prefersCharacterPriority: { type: "boolean" },
            prefersEmptyShotPriority: { type: "boolean" },
          },
          required: ["memoryUser"],
        },
      },
    ...
    switch (name) {
      ...
      case "record_feedback": {
        const input = z.object({
          ...
          rejectedWorkflowPaths: z.array(WorkflowPathIdSchema).optional().default([]),
          providers: z.array(MemoryProviderSchema).optional().default([]),
          editingHints: z.array(z.string().min(1)).optional().default([]),
          cameraHints: z.array(z.string().min(1)).optional().default([]),
          modelIds: z.array(z.string().min(1)).optional().default([]),
        ...
        await recordPreferenceFeedback({
          ...
          rejectedWorkflowPaths: input.rejectedWorkflowPaths,
          providers: input.providers,
          editingHints: input.editingHints,
          cameraHints: input.cameraHints,
      ...
      case "recommend_paths": {
        const input = z.object({
          ...
          hasImageReference: z.boolean().optional().default(false),
          hasReferenceVideo: z.boolean().optional().default(false),
          hasFirstFrameReference: z.boolean().optional().default(false),
          hasLastFrameReference: z.boolean().optional().default(false),
          wantsMultiClip: z.boolean().optional().default(false),
          prefersCharacterPriority: z.boolean().optional().default(false),
          prefersEmptyShotPriority: z.boolean().optional().default(false),
        }).parse(args);
        ...
        const result = await recommendWorkflowPaths({
          ...
          hasFirstFrameReference: input.hasFirstFrameReference,
          hasLastFrameReference: input.hasLastFrameReference,
          wantsMultiClip: input.wantsMultiClip,
          prefersCharacterPriority: input.prefersCharacterPriority,
          prefersEmptyShotPriority: input.prefersEmptyShotPriority,
        });
        return json(result);
      }
